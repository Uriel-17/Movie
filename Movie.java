...
public class Movie implements Comparable<Movie>{
    ...
    @Override public boolean equals(Object o) {
        ...
        if(o == this) {
            ...
            if((this.getDirector().equals(L.getDirector())) && (this.getTitle().equals(L.getTitle()))) {
    ...
    public int compareTo(Movie otherMovie) {
        ...
        if(this.equals(otherMovie)) {
        ...
        } else if(!(getTitle().equals(otherMovie.getTitle()))) {

            if(getTitle().compareTo(otherMovie.getTitle()) < 0) {
            ...
            return getDirector().compareTo(otherMovie.getDirector());
